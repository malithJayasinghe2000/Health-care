                                            ...
                                            <form action = "update" method = "post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" name = "phone" class="form-control" value="<%= phone %>" pattern = "[0-9]{10}" title = "Phone number must be 10 digits">
                                                    </div>
                                                </div><br>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <p class="m-b-10 f-w-600">Email</p>
                                                        <input type="text" name = "email" class="form-control" value="<%= email %>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title = "eg: abcd@xyz.com" >
                                                    </div>
                                                        <div class="col-sm-6">
                                                            <p class="m-b-10 f-w-600">Password</p>
                                                            <input type="text" name = "password" class="form-control" value="<%= password %>" pattern = ".{8,}" title = "Eight or more characters">
                                                        </div>
                                                </div><br>
                                                <div class="row">
